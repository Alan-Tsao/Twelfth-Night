...
window.allCasts = [
  ...
  },
  {
    ...
    desc: "阿希Axi 擅長陪聊與各種奇妙的特殊互動，能在談笑之間替夜晚召來一點不可思議的歡愉。若您想體驗通靈、聽故事，或見識傳說中〈海都麻醉師〉的獨特氣場，她會用帶點胡鬧又充滿角色感的節奏，陪您走進一場不太正經、卻很難忘的夢境。",
  ...
  },
  {
    ...
    quote: "今晚來點甜的。",
    tags: ["服裝店員","輕 RP", "服裝穿搭", "談心交流"],
    filterTags: ["rp","ootd", "chat", "fishing"],
    status: "available",
    statusLabel: "接受指名",
    role: "服裝店員",
    workDays: [5, 6],
