...
window.allCasts = [
  ...
  },
  {
    ...
    personalMenu: [
      {
        title: "🎩｜迷宮出演",
        desc: "日隨、寶圖、多變迷宮、青魔學技：僅限指名期間",
        price: "每節加價 20 萬。"
      },
      {
        title: "💀｜深層迷宮",
        desc: "深層迷宮（天宮、優宮）百層登頂，需另行預約；成功登頂後才收費。",
        price: "（天宮、優宮）百層登頂：200 萬"
      },
      {
        title: "🎤｜聲音特典",
        desc: "唱歌、指定台詞錄音。",
        price: "唱歌：每首 50 萬。指定台詞錄音：每段 30 萬（15秒內）。"
      },
    ]
  },
  {
  ...
  },
  {
    ...
    desc: "艾詡擅長以溫雅而從容的方式迎接每一次相遇，不刻意追逐熱鬧，也不讓片刻沉默變得疏遠。他會細心聆聽旅人帶來的故事,陪你談笑、分享心情，讓原本偶然經過的夜晚，漸漸成為值得珍藏的回憶。她不渴望成為火焰,只願如其名，在夜晚散去之後，仍能留下些許溫暖。",
    shortDesc: "輕 RP。",
    quote: "願今晚的相遇，能成為您再次駐足的理由。",
    tags: ["輕RP","談心交流",],
    filterTags: ["chat","rp","personal"],
    status: "available",
    statusLabel: "接受指名",
  ...
  {
    name: "貓蟲",
    image: "images/staff-31.jpg",
    desc: "不像夜色裡張揚的燈火，更像一盞放在角落的暖燈。高大的身影或許讓人第一眼有些拘謹，相處後卻會發現他比想像中安靜，也比想像中有耐心。不擅長刻意討好，也不急著拉近距離。若今晚恰好無處可去，或許可以來坐坐。",
    shortDesc: "輕 RP。",
    quote: "比起言語，我更擅長用行為表達。如果你想找我，我一直都在。",
    tags: ["輕RP","談心交流",],
    filterTags: ["chat","rp","personal"],
    status: "available",
    statusLabel: "接受指名",
  ...
  },
  {
    ...
    desc: "如果能成為你在黑暗困境中的一絲微弱燈火，那我將盡力燃燒為你帶來微不足道的溫暖，希望這小小的火焰能夠指引你找到前進的方向，依里絲是個內向的兔子，但會盡量搜尋落單的人搭話哦。",
    shortDesc: "輕 RP。",
    quote: "夜落僅一瞬，相遇即永恆。",
    tags: ["輕RP","談心交流",],
    filterTags: ["chat","rp","personal"],
